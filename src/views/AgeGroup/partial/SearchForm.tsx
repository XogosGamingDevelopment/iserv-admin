...
import { AgeGroupStatus } from "../../../constants/status";
...
const SearchForm: React.FC<SearchFormProps> = (props) => {
  const { searchForm, setSearchForm, handleSearchClick } = props; //destructure data from props
  ...
  //Search handler
  const searchData = () => {
    if (!searchForm.search_string && !searchForm.status) {
