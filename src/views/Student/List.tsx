...
const List: React.FC = () => {
  ...
  const getListData = React.useCallback(async () => {
    ...
    try {
      ...
      setResults(response.data.studentslists.docs);
      setTotalItems(response.data.studentslists.totalDocs);
    } catch (error: any) {
  ...
  const changeStudentStatus = async (userid?: string, status?: number) => {
  ...
  const deleteStudent = async (itemid?: string) => {
  ...
  return (
    <>
      ...
      <PageToolbar title="Student List" />
                      ...
                      <tr key={item?._id}>
                        <td>
                          <div className="d-flex align-items-center">
                            ...
                            ></span>
                            <div className="symbol symbol-50px symbol-circle overflow-hidden me-3">
                        ...
                        <td className="text-center">
                          <div className="d-flex">
                            ...
                            {hasAuthorization("block_unblock", "student") && (
                              <TooltipWrapper
                              ...
                              >
                                <span
                                  className="btn btn-sm btn-icon btn-light btn-active-light-warning me-2"
                                  onClick={() =>
                                    changeStudentStatus(item?._id, item?.status)
                                  }
                                >
                            ...
                            {hasAuthorization("delete", "student") && (
                              <TooltipWrapper
