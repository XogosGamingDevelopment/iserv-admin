...
const List: React.FC = () => {
  ...
  const changeTeacherStatus = async (userid?: string, status?: number) => {
  ...
  const deleteTeacher = async (itemid?: string) => {
    const message = `Are you sure you want to delete the Teacher?`;
    deleteItem(`users/delete-teacher/${itemid}`, message, getListData);
  };
  ...
  return (
    <>
      ...
      <PageToolbar title="Teacher List" />
                      ...
                      <tr key={item._id}>
                        ...
                        <td className="text-center">
                          <div className="d-flex">
                            {hasAuthorization("view", "teacher") && (
                              ...
                              >
                                <Link
                                  ...
                                  to={`/teacher-detail/${item._id}`}
                                >
                                  <i className="ki-outline ki-eye text-primary fs-2"></i>
                                </Link>
                              </TooltipWrapper>
                            )}
                            {hasAuthorization("admin_approval", "teacher") && (
                              <TooltipWrapper
                            ...
                            {hasAuthorization("block_unblock", "teacher") && (
                              <TooltipWrapper
                              ...
                              >
                                <span
                                  className="btn btn-sm btn-icon btn-light btn-active-light-warning me-2"
                                  onClick={() =>
                                    changeTeacherStatus(item?._id, item?.status)
                                  }
                                >
                            ...
                            {hasAuthorization("delete", "teacher") && (
                              <TooltipWrapper
